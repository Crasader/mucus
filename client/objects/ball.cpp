...
namespace objects
{
            ...
            : BaseObject(description)
        {
            ...
            cc::Texture2D* texture = new cc::Texture2D();
            texture->autorelease();
            texture->initWithData(color, sizeof(color), cc::kCCTexture2DPixelFormat_RGB888, 1, 1, pr::Vec2(1, 1).toCCSize());
            _sprite = cc::Sprite::createWithTexture(texture);
